...
namespace NeuralNetwork1
{
    public partial class NeuralNetworksStand : Form
    {
        ...
        {
            FigureType fg = FigureType.Undef;
            switch (figName)
            {
                case "Mercury": fg = FigureType.Mercury; break;
                case "Venus": fg = FigureType.Venus; break;
                case "Earth": fg = FigureType.Earth; break;
                case "Mars": fg = FigureType.Mars; break;
                case "Jupiter": fg = FigureType.Jupiter; break;
                case "Saturn": fg = FigureType.Saturn; break;
                case "Uranus": fg = FigureType.Uranus; break;
                case "Neptune": fg = FigureType.Neptune; break;
                case "Sun": fg = FigureType.Sun; break;
                case "Moon": fg = FigureType.Moon; break;

                default:
                    break;
            }

            Sample fig = generator.GenerateExtFigure(bm, fg, pictureBox1);
